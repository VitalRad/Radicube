 ...
 **********************************************/
 ...
 try {
      ...
      BasicManager.restoreCmd = prop.getProperty("restoreCmd");
      BasicManager.QUERY_TYPE = Integer.parseInt(prop.getProperty("QUERY_TYPE"));
      BasicManager.ACCEPT_TO = Integer.parseInt(prop.getProperty("ACCEPT_TO"));
      ...
      if((this.downloadedFiles == null)||
        ...
        ( this.TEL_MSG == null)||
        ( BasicManager.restoreCmd == null)||
        ( BasicManager.QUERY_TYPE < 0)||
        ( BasicManager.ACCEPT_TO < 0))
        {
...
private void doRestore()
{
  ...
  try
  {
   url = new java.net.URL(BasicManager.restoreCmd);
   ...
   {
     e.printStackTrace();
     log_writer.doLogging_QRmgr(logRoot, logName, "QRmanager.doRestore() error: "+e);
     System.exit(0);
   }
}
