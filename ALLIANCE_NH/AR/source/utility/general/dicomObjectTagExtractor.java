 ...
 **********************************************************/
 ...
 private String[] retrievedThusFar = null;
			      ...
			      for(int d = 0; d < tags.length; d++)
			         {
                      if(tags[d] == null)
                        {
					     breakNow = false; //nope, not yet.
					     break;
					    }
					 }
				  if(breakNow)
				    {
				     this.retrievedTags = this.retrievedThusFar;
			         break;
					}
