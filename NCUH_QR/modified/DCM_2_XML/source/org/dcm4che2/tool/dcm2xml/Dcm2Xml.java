 ...
 * @since Aug 15, 2005
 *
 * On March 20, 2012, Michael Bassey & Edgar Luberenga made modifications to some sections of these code.
 * Sections modified include:
 * (1) Lines 164 to 222 (Definition/addition of a new method, with the new method's implementation
 *                       borrowing largely from "parse" method on line 100).
 */
public class Dcm2Xml {
    ...
    public void startOp(String[] args, Dcm2Xml dcm2xml) {
