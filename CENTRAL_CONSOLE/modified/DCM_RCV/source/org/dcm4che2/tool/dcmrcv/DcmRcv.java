 ...
 * On June 05, 2012, Michael Bassey & Edgar Luberenga made modifications to some sections of these code.
		 ...
		 if(nj == null)
		   {
			...
			if(fLoc == null)
			...
			else
			  {
               ...
               //=====================================================
               int numImgsUploaded = Integer.parseInt(jobDets[jobDets.length - 1]);
			   ...
			   nJob.set_nhJob(nj);
			   nJob.setJobType(2);
			   nJob.set_imagesUploaded(numImgsUploaded);
			   //----------------------------
