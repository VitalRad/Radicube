		   ...
		   if(fileLocation == null)
		   ...
		   else
			 {
			  ...
			  if(accessionNo == null)
				...
				{
				 int argLength = ((currentModalities.length * 2) + 14);

				 String[] arg_1 = new String[12];
				 arg_1[0] = "-acceptTO";
		         arg_1[1] = "1800000";
				 arg_1[2] ="-L";
...
//====================================================================================================
 ...
 //////////////////////////////////////////////////////////////
 //
 //  Used to run a job taking over from current executing one.
 //
 /////////////////////////////////////////////////////////////
 class startTakingOverJob implements Runnable {

 private QRjob cJob = null;

 public startTakingOverJob(QRjob cJob){
