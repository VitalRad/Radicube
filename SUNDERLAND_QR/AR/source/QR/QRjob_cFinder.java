...
protected String[] modify_singleQuote(String[] data)
{
 try
 {
 ...
 {
   e.printStackTrace();
   log_writer.doLogging_QRmgr(logRoot, logName, "<QRjob_cFinder.modify_singleQuote()> exception: "+e);
 }
return data;
}
