 ...
 * On March 03, 2012, Michael Bassey & Edgar Luberenga made additions to sections of this code.
...
public class Association implements Runnable {
    ...
    private DcmRcv dcmrcvObject_2 = null;

    private int JOB_NUM = -1;
    private String logRoot = null;
    private String logName = null;
    private int assocQueueIndex = -1;
    //---------------------------------------------------------------
    ...
    public void set_JOB_NUM(int JOB_NUM)
    {
	...
	public void set_assocQueueIndex(int assocQueueIndex)
	{
	 this.assocQueueIndex = assocQueueIndex;

	 System.out.println("ASSOC Index = "+this.assocQueueIndex);
	}

	public int get_assocQueueIndex()
	{
	 return this.assocQueueIndex;
	}


	public void setLogsLoc(String logRoot, String logName)
	{
    ...
    public void set_ARuid(String val)
    {
	 this.AR_uid = val;
	}


	public void set_dcmrcvObject_2(DcmRcv dcmrcvObject_2)
	{
	 this.dcmrcvObject_2 = dcmrcvObject_2;
	}

	public DcmRcv get_dcmrcvObject_2()
	{
	 return this.dcmrcvObject_2;
	}
   ...
   String jobTxtFileName = BasicManager.JOBS_IN_PROG_FILE+"/"+"jb_"+get_JOB_NUM()+".txt";
   jobTxtFileName = utility.general.genericJobs.prepareFilePath(jobTxtFileName, logRoot, logName);
   String strToWrite_2 = "dead\r\n";
   ...
   {
	 log_writer.doLogging_QRmgr(logRoot, logName, "<Association error: Exception in retrieving timeZone "+tzErr);
   }
   //===================================


   strToWrite_2 = "End time = "+currentTime+"\r\n";
   utility.general.genericJobs.writeText(jobTxtFileName,
										 strToWrite_2,
										 logRoot,
										 logName,
